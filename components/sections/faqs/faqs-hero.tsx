...
export function FAQsHeroSection() {
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden">
      ...
      <div className="relative z-10 w-full px-4 sm:px-6 lg:px-12 xl:px-16 py-32">
        <motion.div
        ...
        >
          ...
          <p className="text-base md:text-lg lg:text-xl text-white/90 mb-8 leading-relaxed">
            Find answers to common questions about our IT solutions, services,
            pricing, and support. Can't find what you're looking for? Contact
            our team.
          </p>
