  ...
  return (
    <section className="py-24 md:py-32" style={{ backgroundColor: "#f1f0ee" }}>
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-[1600px]">
        ...
        {/* Desktop View - Animated Beams */}
        <div className="hidden lg:block mb-20">
          <div
            ref={containerRef}
            className="relative mx-auto flex max-w-5xl items-center justify-between h-[500px]"
          >
            {/* Left Side Companies */}
        ...
        <div className="lg:hidden mb-20">
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-6 max-w-2xl mx-auto">
            ...
            <CompanyCard className="col-span-2 sm:col-span-1 mx-auto">
              <Image
                src="/images/timeline/Upright Logo1.png"
                alt="Upright Systems"
                width={160}
