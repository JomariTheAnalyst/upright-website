...
function RevealImageListItem({ text, images }: ShowImageListItemProps) {
  ...
  return (
    <div className="group relative h-fit w-fit overflow-visible inline-block">
      <h1
        className="text-5xl md:text-7xl font-bold tracking-tighter transition-all duration-500 group-hover:opacity-40 drop-shadow-2xl"
        style={{ color: "#ffe419" }}
      >
        {text}
      </h1>
